...
import com.mbweskley.mobileproject.databinding.FragmentDoingBinding
...
class DoingFragment : Fragment() {
    ...
    private fun initAdapter() {
        binding.rvAndamento.layoutManager = LinearLayoutManager(requireContext())
        binding.rvAndamento.setHasFixedSize(true)
        taskAdapter = TaskAdapter(tasksList) { task, select ->
            optionSelect(task, select)
        }
        binding.rvAndamento.adapter = taskAdapter
    }
